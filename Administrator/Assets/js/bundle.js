    ...
    var CheckLogin = function () {
        ...
        _createClass(CheckLogin, [{
            ...
            value: function checkLogin() {
                var input_email = helpers_1.Validation.cleanInput(this._email);
                if (helpers_1.Validation.validEmail(input_email)) {
                    if (this._password.length < 7) return false;
                    return true;
                }
                return false;
            }
...
btn_BtnLogin.addEventListener('click', function () {
    ...
    if (validClassLogin.checkLogin()) {
        ...
        sweetalert2_1.default.fire({
            type: 'error',
            title: 'Oops...',
            text: 'el campo de contrase&ntilde;a y/o correo se encuentran vacios',
            showConfirmButton: false
        });
    }
});

},{"./LoginClass":2,"sweetalert2":1}]},{},[4])
