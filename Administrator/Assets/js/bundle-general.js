...
(function (GroupClass) {
    var InsertGroup = function () {
        function InsertGroup(Id, Name, Description, Readuser, Createuser, Updateuser, Deleteuser, Readgroup, Creategroup, Updategroup, Deletegroup, Readpermission, Createpermission, Updatepermission, Deletepermission, Reademail, Createemail, Updateemail, Deleteemail, Status, HighUser) {
            _classCallCheck(this, InsertGroup);

            this._Id = Id, this._Name = Name, this._Description = Description, this._Readuser = Readuser, this._Createuser = Createuser, this._Updateuser = Updateuser, this._Deleteuser = Deleteuser, this._Readgroup = Readgroup, this._Creategroup = Creategroup, this._Updategroup = Updategroup, this._Deletegroup = Deletegroup, this._Readpermission = Readpermission, this._Createpermission = Createpermission, this._Updatepermission = Updatepermission, this._Deletepermission = Deletepermission, this._Reademail = Reademail, this._Createemail = Createemail, this._Updateemail = Updateemail, this._Deleteemail = Deleteemail, this._Status = Status, this._HighUser = HighUser;
        }

        _createClass(InsertGroup, [{
            key: "validInsertGroup",
            value: function validInsertGroup() {
                var input_name = void 0;
                var input_description = void 0;
                if (this._HighUser == 0 && this._Name == "") return 'datarequired';
                input_name = helpers_1.Validation.cleanInput(this._Name);
                input_description = helpers_1.Validation.cleanInput(this._Description);
                if (input_name.length > 4 && input_name.length < 30) return 'succes';
                return 'fail';
            }
        }, {
            key: "Insert",
            value: function Insert(url) {
                var input_name = helpers_1.Validation.cleanInput(this._Name);
                var input_description = helpers_1.Validation.cleanInput(this._Description);
                var insert = {
                    Data: {
                        'Id': this._Id,
                        'Name': input_name,
    ...
    GroupClass.InsertGroup = InsertGroup;
})(GroupClass = exports.GroupClass || (exports.GroupClass = {}));

},{"./helpers":4}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", { value: true });
var GroupClass_1 = require("./GroupClass");
var sweetalert2_1 = require("sweetalert2");
var add_group_btn = document.getElementById('add_group_btn');
var infouser = document.getElementById('infohidde').value;
...
add_group_btn.addEventListener('click', function () {
    sweetalert2_1.default.fire({
        ...
        preConfirm: function preConfirm() {
            ...
            var create_group = document.getElementById('create_group').checked;
            var update_group = document.getElementById('update_group').checked;
            var delete_group = document.getElementById('delete_group').checked;
            var read_group = document.getElementById('read_group').checked;
            var create_user = document.getElementById('create_user').checked;
            var update_user = document.getElementById('update_user').checked;
            var delete_user = document.getElementById('delete_user').checked;
            var read_user = document.getElementById('read_user').checked;
            var create_permission = document.getElementById('create_permission').checked;
            var update_permission = document.getElementById('update_permission').checked;
            var delete_permission = document.getElementById('delete_permission').checked;
            var read_permission = document.getElementById('read_permission').checked;
            var create_email = document.getElementById('create_email').checked;
            var update_email = document.getElementById('update_email').checked;
            var delete_email = document.getElementById('delete_email').checked;
            var read_email = document.getElementById('read_email').checked;
            var groupclass = new GroupClass_1.GroupClass.InsertGroup(0, group_name, group_description, read_user, create_user, update_user, delete_user, read_group, create_group, update_group, delete_group, read_permission, create_permission, update_permission, delete_permission, read_email, create_email, update_email, delete_email, true, parseInt(infouser));
            if (group_name == '') {
...
},{"./GroupClass":2,"sweetalert2":1}],4:[function(require,module,exports){
"use strict";
...
//# sourceMappingURL=bundle-general.js.map
